...
from tss.zatca.clearence_util import bg_generate_einvoice
...
B2C_COMPLIANCE_BATCH_JOB_ID = "tss:b2c_compliance_batch_submit"
...
def send_multiple_signed_compliance_invoices_to_zatca():
    ...
    """
    frappe.enqueue(
        "tss.zatca.background_task._run_send_multiple_signed_compliance_invoices_to_zatca",
        queue="long",
